...
// Elimina memory issues como: null pointers, dangling pointers, data races
// Elimina el Garbage Collector
// El procesamiento paralelo es facil de implementar
...
#[derive(Debug)] // La estructura va implementar un trato que se llama Debug
struct Apple {}
